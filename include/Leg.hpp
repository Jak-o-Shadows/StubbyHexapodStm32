...
#define PHASE_MIN 272 //Clockwise from neutral
#define PHASE_NEUTRAL 336
#define PHASE_MAX 400 //Counter clockwise from neutral
...
#define SERVO_TRAVEL (90 * M_PI / 180)
...
public:
	/*
		 ...
		 */
	Leg(uint8_t index, uint8_t tibia_idx, uint8_t femur_idx, uint8_t coxa_idx, double mounting_angle, Point neutralP, uint16_t *servoPos);
	...
	/*
		 * Gets the specified servo index
		 */
	uint8_t getServoIdx(uint8_t joint);
};
#endif
